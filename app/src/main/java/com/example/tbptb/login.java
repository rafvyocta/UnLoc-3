    ...
    public void menu_utama(View view){
        ...
        call.enqueue(new Callback<AuthClass>() {
            ...
            public void onResponse(Call<AuthClass> call, Response<AuthClass> response) {
                ...
                if(authClass != null){
                    SharedPreferences sharedPreferences = getSharedPreferences("com.example.tbptb.PREFS",MODE_PRIVATE);
                    SharedPreferences.Editor editor = sharedPreferences.edit();
                    editor.putString("token",authClass.getToken());
                    editor.putString("nama", authClass.getNama());
                    editor.putString("username", authClass.getUsername());
                    editor.putString("email", authClass.getEmail());
                    editor.putString("no_hp", authClass.getNoHp());
                    editor.apply();
